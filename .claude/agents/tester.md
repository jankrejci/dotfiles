---
name: tester
description: Test strategy specialist. Use after explorer analysis to define test requirements that ensure system robustness. Identifies edge cases, failure modes, and validation criteria.
