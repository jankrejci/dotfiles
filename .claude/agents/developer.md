---
name: developer
description: Implementation specialist. Use after explorer and tester phases to implement changes using idiomatic patterns and best practices. Writes clean, simple code following established conventions.
