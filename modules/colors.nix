...
# so both palettes are defined manually here.
{
  ...
  options.colorScheme.stormPalette = lib.mkOption {
    type = lib.types.attrsOf lib.types.str;
    readOnly = true;
    description = "Tokyo Night Storm base16 palette for medium-dark mode toggle.";
    default = {
      accent = "7AA2F7"; # semantic accent -- blue for dark variants
      panelBg = "1F2335"; # chrome -- sidebar, statusbar, tab bar
      base00 = "24283B"; # bg -- storm editor background
      base01 = "292E42"; # lighter bg -- line highlight, status bar
      base02 = "343A52"; # selection -- visual mode highlight
      base03 = "565F89"; # comments -- inline annotations
      base04 = "787C99"; # dark fg -- line numbers, fold markers
      base05 = "A9B1D6"; # default fg -- primary text
      base06 = "C0CAF5"; # light fg -- headings, bold text
