---
name: explorer
description: Research and analysis specialist. Use PROACTIVELY at the start of any non-trivial task to analyze requirements, explore codebase, check documentation, and suggest implementation paths including non-obvious alternatives.
