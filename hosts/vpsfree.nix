...
in {
  ...
  systemd.network.netdevs."50-wg-thinkcenter" = {
    netdevConfig = {
      Kind = "wireguard";
      Name = "wg-thinkcenter";
    };
    wireguardConfig = {
      PrivateKeyFile = "/root/secrets/wg-vpsfree-private";
      ListenPort = 51820;
    };
    wireguardPeers = [
      {
  ...
  systemd.network.networks."50-wg-thinkcenter" = {
    matchConfig.Name = "wg-thinkcenter";
